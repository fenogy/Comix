...
import io.fenogy.comix.view.VerticalViewPager;
...
public class ReadingFragment extends Fragment implements View.OnTouchListener {
    ...
    public static ReadingFragment create(int comicId) {
    ...
    public static ReadingFragment create(File comicpath) {
        ReadingFragment fragment = new ReadingFragment();
        Bundle args = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mPageSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStartTrackingTouch(SeekBar seekBar) {
                mPicasso.pauseTag(ReadingFragment.this.getActivity());
            }

            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {
                mPicasso.resumeTag(ReadingFragment.this.getActivity());
            }
        });
...
//                break;
    ...
    private class ComicPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            pageImageView.setOnTouchListener(ReadingFragment.this);
